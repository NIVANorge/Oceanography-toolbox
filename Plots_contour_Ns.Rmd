...
VR48_NH4 <- okokyst_plot(data = VR48, varname = "NH4", ctd_variable = FALSE,
                   colored_points = TRUE, limits = grenser, binwidth = 20, max_timediff = 25, ylabel = F, xlabel = F) +
                    scale_fill_gradientn(name= expression("NH"[4]), limit=grenser, colours = jet.colors(16), breaks = c(20,40,60), oob=squish) +
                      ...
                      theme(axis.text.x=element_text(size=rel(1.5), angle=60, hjust=1), plot.title = element_text(hjust = 0.5))
VR48_NH4
...
plot (Nitrogen)
  ggsave("Figures/VR48/VR48_nitrogen_panel_220317.png", plot = Nitrogen,  width = 8, height = 6)
...
VT16_TOTN <- okokyst_plot(data = VT16, varname = "TOTN", ctd_variable = F,
                   colored_points = T, limits = grenser, binwidth = 20, max_timediff = 21, ylabel = F, xlabel = F) +
                    scale_fill_gradientn("TOTN", colours = jet.colors(20), limits= grenser, breaks = c(100,200,300,400), oob=squish) +
                    scale_x_datetime(date_breaks = "2 month", labels =  NULL)
...
VT16_NO3 <- okokyst_plot(data = VT16, varname = "NO3_NO2", ctd_variable = FALSE,
                   colored_points = TRUE, limits =grenser, binwidth = 20, max_timediff = 21, ylabel = F, xlabel = F) +
                    scale_fill_gradientn(name= expression("NO"[3]* "+ NO"[2]), limits=grenser, colours = jet.colors(16), breaks = c(50,100,150), oob=squish) +
                      scale_x_datetime(date_breaks = "2 month", labels =  NULL)
...
ggsave ("Figures/VT70/VT70_TOTN_longtimseries.png", dpi=500, width = 8, height = 3)
...
ggsave ("Figures/VT70/VT70_NO3_longtimeseries.png", dpi=500, width = 8, height = 3)
...
ggsave ("Figures/VT70/VT70_NH4_longtimeseries.png", dpi=500, width = 8, height = 3)
...
plot (Nitrogen)
  ggsave("Figures/VT70/VT70_nitrogen_panel_longtimeseries.png", plot = Nitrogen,  width = 8, height = 6)
...
ggsave ("Figures/VT70/VT70_PO4_longtimeseries.png", dpi=500, , width = 8, height = 3)
```
...
ggsave ("Figures/VT70/VT70_TOTP.png_longtimeseries", dpi=500, width = 8, height = 3)
...
plot (VT70_fosfat_Si)
ggsave("Figures/VT70/VT70_fosfat_Si_panel_longtimeseries.png", plot = VT70_fosfat_Si,  width = 8, height = 6)
...
ggsave ("Figures/VT70/VT70_KlfA_longtimeseries.png" , width = 8, height = 3)
```
...
VT74_NO3 <- okokyst_plot(data = VT74, varname = "NO3_NO2", ctd_variable = FALSE,
                   colored_points = TRUE, limits =grenser, binwidth = 20, max_timediff = 25, ylabel = F, xlabel = F) +
                    scale_fill_gradientn(name= expression("NO"[3]* "+ NO"[2]),limit=grenser, colours = jet.colors(16), breaks = c(50,100,150), oob=squish) +
                      scale_x_datetime(date_breaks = "2 month", labels =  NULL)
...
```{r echo=FALSE}
save.image (file = "Plots_contour_Ns.Rdata")
```
