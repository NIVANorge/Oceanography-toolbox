...
ggsave ("Figures/VT8_TOTN.png", dpi=500, width = 8, height = 3)
...
ggsave ("Figures/VT8_NO3.png", dpi=500, width = 8, height = 3)
...
ggsave ("Figures/VT8_NH4.png", dpi=500, width = 8, height = 3)
...
ggsave ("Figures/VT8_PO4.png", dpi=500, , width = 8, height = 3)
```
...
ggsave ("Figures/VT8_TOTP.png", dpi=500, width = 8, height = 3)
```
...
ggsave ("Figures/VT8_SIO2.png", dpi=500, width = 8, height = 3)
...
# combine figures, here combine two NO3 for different stations
#NB can of curse combine different variables for one station as well 
VT8_FOSFAT <- VT8_TOTP + VT8_PO4 +plot_layout(ncol = 1)
plot (VT8_FOSFAT)
ggsave("Figures/VT8_fosfat_panel.png", plot = VT8_FOSFAT)
...
ggsave ("Figures/VT8_KlfA.png", dpi=500, , width = 8, height = 3)
```
...
# combine figures, here combine two NO3 for different stations
#NB can of curse combine different variables for one station as well 
VT8_all <- VT8_TOTN+ VT8_NO3+ VT8_NH4+ VT8_TOTP +  VT8_PO4 + VT8_SIO2 + VT8_KlfA + plot_layout(ncol = 1)
plot (VT8_all)
ggsave("Figures/VT8_fosfatsilikat_panel.png", plot = VT8_all, dpi=500, , width = 8, height = 3)
```
